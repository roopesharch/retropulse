...
function getISTTimestamp() {
    const now = new Date();
    // Format to IST string (e.g., "2026-08-04 07:45:00")
...
app.post('/api/log', async (req, res) => {
    ...
    try {
        ...
        // Note: We only set 'created_at' if it's a brand new user. If they already exist, 
        // we leave created_at alone and only update updated_at and update_count.
        const payload = {
            ip: geoData.ip,
            city: geoData.city,
